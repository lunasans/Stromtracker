    ...
    <div class="row mb-4" data-animate="slide-in-up">
        <div class="col-12">
            <div class="glass-light"
                ...
                <!-- Background Pattern -->
                <div
                    style="position: absolute; top: 0; right: 0; width: 200px; height: 200px; opacity: 0.1; background: radial-gradient(circle, var(--energy-400) 0%, transparent 50%); border-radius: 50%;">
                </div>
                    ...
                    <div class="col-md-4 text-end">
                        <div class="d-flex justify-content-end align-items-center gap-3">
                            ...
                            <div class="position-relative">
                                ...
                                <div
                                    style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: var(--text-xs); font-weight: var(--font-bold); color: white;">
                                    ⚡
                                </div>
                            </div>
                        </div>
                ...
                <div style="margin-top: var(--space-3);">
                    <div style="width: 40px; height: 40px; position: relative;">
                        <svg width="40" height="40">
                            <circle cx="20" cy="20" r="16" stroke="var(--info-200)" stroke-width="3" fill="none">
                            </circle>
                        ...
                        <div
                            style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 10px; font-weight: bold; color: var(--info-600);">
                            75%
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-8 mb-4" data-animate="slide-in-left">
            <div class="glass-light" style="border-radius: var(--radius-2xl); padding: var(--space-6); height: 400px;">
                ...
                <div style="position: relative; height: 300px;">
                    ...
                    <!-- Loading State -->
                    <div class="loading-skeleton" id="chartLoading"
                        style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; border-radius: var(--radius-lg);">
                        <div
                            style="height: 100%; display: flex; align-items: center; justify-content: center; color: var(--neutral-500);">
                            <div class="text-center">
                                <div class="loading-skeleton" style="width: 200px; height: 20px; margin: 0 auto 10px;">
                                </div>
            ...
            <div class="glass-light" style="border-radius: var(--radius-2xl); padding: var(--space-6);"
                ...
                <div class="space-y-3">
                    <div class="d-flex gap-3"
                        style="padding: var(--space-3); background: var(--success-50); border-radius: var(--radius-lg); border-left: 4px solid var(--success-500);">
                        <div style="flex-shrink: 0;">💡</div>
                        <div>
                            <div
                                style="font-size: var(--text-sm); font-weight: var(--font-semibold); color: var(--success-700);">
                    ...
                    <div class="d-flex gap-3"
                        style="padding: var(--space-3); background: var(--info-50); border-radius: var(--radius-lg); border-left: 4px solid var(--info-500);">
                        <div style="flex-shrink: 0;">🔌</div>
                        <div>
                            <div
                                style="font-size: var(--text-sm); font-weight: var(--font-semibold); color: var(--info-700);">
                    ...
                    <div class="d-flex gap-3"
                        style="padding: var(--space-3); background: var(--warning-50); border-radius: var(--radius-lg); border-left: 4px solid var(--warning-500);">
                        <div style="flex-shrink: 0;">🌡️</div>
                        <div>
                            <div
                                style="font-size: var(--text-sm); font-weight: var(--font-semibold); color: var(--warning-700);">
                                Heizung optimieren
                            </div>
